...
description: This skill should be used when the user asks about "CLAUDE.md setup", "new project setup", "bootstrap project", "PRD to project", or needs to prepare a greenfield project for devloop workflows.
whenToUse: |
  ...
  - Creating initial .devloop/ directory structure
whenNotToUse: |
  - Existing codebase with code already - use /devloop:onboard
  - Quick additions - don't over-engineer simple file additions
  - No documentation exists - use /devloop to start directly
  - Project already has CLAUDE.md configured
---
...
## Devloop Workflow Section

**REQUIRED**: Include this section in every CLAUDE.md generated by bootstrap.

This teaches agents how to work with devloop, ensuring they follow completion requirements.
...
- Complete tasks without marking them done in the plan
- Skip commits between tasks
- Not follow conventional commit format
- Miss version/changelog updates at phase completion

This section serves as in-context training for agents working on the project.
