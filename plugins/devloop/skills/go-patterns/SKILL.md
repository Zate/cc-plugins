---
name: go-patterns
description: This skill should be used for Go idioms, error handling, goroutines, interfaces, and testing
whenToUse: Go code, Go patterns, goroutines, Go testing
whenNotToUse: Non-Go code, CGo interop
---
